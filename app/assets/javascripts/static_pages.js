...
//Does calculations for equals, should update database on # of calculations
...
function display_result(){
  if(last_result!=''){
    ...
    history_index=1;
    document.calculator.line.style.backgroundColor='white';
  }else{
    document.calculator.line.style.backgroundColor='white';
  }
}
...
function displayInstructions() {
  $(".documentation").html("<%= render 'layouts/instructions' %>");
}
